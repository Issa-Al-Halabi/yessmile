...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2024 at 12:48 PM
...
--
-- Table structure for table `about_our_clinics`
--

CREATE TABLE `about_our_clinics` (
...
CREATE TABLE `about_us` (
  ...
  `banner_button` varchar(255) NOT NULL,
...
CREATE TABLE `footer` (
  ...
  `email` varchar(255) NOT NULL,
  `socials` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`socials`)),
  `book_now` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`book_now`)),
  `lat` varchar(255) NOT NULL,
  `lang` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(17, '2024_03_03_185458_create_who_we_are_table', 1),
(18, '2024_03_03_185459_create_about_us_table', 1),
(19, '2024_03_05_120259_create_notifications_table', 1),
(20, '2024_03_06_071600_create_about_our_team_table', 1),
(21, '2024_03_06_114339_create_news_table', 1),
(22, '2024_03_06_172903_create_about_our_clinics_table', 1);
...
--
-- Indexes for table `about_our_clinics`
--
ALTER TABLE `about_our_clinics`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `about_our_clinics`
--
ALTER TABLE `about_our_clinics`
