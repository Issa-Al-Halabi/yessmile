<main>
    ...
    <div class="md:pt-[5rem] pb-[7rem] relative" style="background-color:#EEF4FB">
        <div class="main-container text-center">
            <h2 class="mb-[3rem] sm:mb-[6rem]">@lang('our_world.articles')</h2>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 relative">
                <div class="lg:col-span-4">
                    <div
                        ...
                        <h3 class="text-[2.4rem] mb-0">@lang('our_world.categories')</h3>
                    ...
                    <div
                        ...
                        <div class="hidden md:flex">
                            <h3 class="text-[3.6rem]">@lang('our_world.categories')</h3>
                        </div>

                        <div class="cat-item selected" term-id="-1">@lang('our_world.all')</div>
                                ...
                                <div
                                    ...
                                    <div class="btn-secondary small left-arrow ">
                                        <a class="transition ease-in  group-hover:scale-[1.1]"
                                            href="{{ url('article/' . $article['id']) }}"> @lang('our_world.continue')</a>
                                    </div>
                                </div>
    ...
    <div class="pt-[3.4rem] md:pt-[10rem] pb-[5rem]" style="background-color:#2A4CC7;margin-bottom:100px">
        <div class="main-container text-center">
            <h2 class="mb-[3rem] sm:mb-[6rem] text-right text-light"> @lang('our_world.last_news')</h2>
        </div>
                        ...
                        <div class="slide-wrap bg-light rounded-[2rem] mb-[3rem]  w-full mx-[1.5rem] relative group">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span class="text-[1.6rem] font-bold text-light/50">{{ $new['date'] }}</span>
                                </div>
                            </div>
                            <a class="absolute left-0 top-0 right-0 bottom-0" href="{{ url('news', $new['id']) }}"></a>
                        </div>
                    @endforeach
